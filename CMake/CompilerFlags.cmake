...
elseif(REALM_PLATFORM STREQUAL "Android")
    ...
    list(APPEND PLATFORM_DEFINES "__STDC_CONSTANT_MACROS=1")
endif()

if(REALM_PLATFORM STREQUAL "Node")
    if(DEFINED CMAKE_JS_VERSION) # building with cmake-js
      list(APPEND PLATFORM_LIBRARIES ${CMAKE_JS_LIB})
      list(APPEND PLATFORM_INCLUDES ${CMAKE_JS_INC})
      list(APPEND PLATFORM_DEFINES "REALM_HAVE_UV" "REALM_PLATFORM_NODE=1")
    else()
        message(FATAL_ERROR "Building for platform Node is only supported under CMake.js!")
    endif()
endif()

if(NOT REALM_PLATFORM)
    find_package(LibUV REQUIRED)
    list(APPEND PLATFORM_LIBRARIES LibUV::LibUV)
    list(APPEND PLATFORM_DEFINES "REALM_HAVE_UV")
endif()

check_symbol_exists(epoll_create sys/epoll.h REALM_HAVE_EPOLL)
if(REALM_HAVE_EPOLL)
    list(APPEND PLATFORM_DEFINES "REALM_HAVE_EPOLL")
endif()
